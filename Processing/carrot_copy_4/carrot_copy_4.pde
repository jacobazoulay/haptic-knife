...
void setup() {
  ...
  //full_body = loadImage("cucumber.png");
  ...
  myPortKnife = new Serial(this, Serial.list()[2], 115200);  //make sure baud rate matches Arduino
  myPortCarrot = new Serial(this, Serial.list()[1], 115200);  //make sure baud rate matches Arduino
  myPortKnife.buffer('\n');
  myPortCarrot.buffer('\n');
}
